...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-[#202124] p-4 relative overflow-hidden transition-colors duration-500">

...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#202124] p-4 relative overflow-hidden transition-colors duration-500">
      {/* Dynamic Animated Background */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-400/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-70 animate-blob" />
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-cyan-400/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
      ...
      <div className="relative z-10 bg-white/70 dark:bg-dark-surface/60 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/20 dark:border-white/5 w-full max-w-md animate-slide-up mx-4">
        <div className="flex flex-col items-center mb-8 md:mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 tracking-tight text-center">Bienvenido</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-2 md:mt-3 font-medium text-center">Inicia sesión para continuar</p>
        </div>
